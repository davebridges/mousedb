...
def experiment_detail(request, experiment):
	...
	return render(request, 'experiment_detail.html', {'experiment' : experiment, 'measurement_plasmaglucose' : measurement_plasmaglucose, 'measurement_seruminsulin': measurement_seruminsulin, 'measurement_bodyweight' : measurement_bodyweight})
...
def experiment_detail_all(request):
	...
	return render(request, 'experiment_detail_all.html', {'measurement_plasmaglucose' : measurement_plasmaglucose, 'measurement_seruminsulin': measurement_seruminsulin, 'measurement_bodyweight' : measurement_bodyweight})
...
def study_experiment(request, study_id):
	...
	return render(request, "study_experiment_form.html", {'form':form, 'study':study, 'treatments': treatments})
